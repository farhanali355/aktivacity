            ...
            <section className="case-study-vsesion01 bg2-clr pb-space">
                <div className="container">
                    <div className="section-title text-center mb-xxl-15 mb-xl-10 mb-8" data-aos="fade-up" data-aos-duration="1000">
                        ...
                        <h2 className="stitle mb-xxl-8 mb-xl-7 mb-xl-5 mb-4 text-white">
                            Where Vision Meets <span className="theme-clr" style={{ fontStyle: 'normal' }}>Measurable Results</span>
                        </h2>
                        <p className="white-clr mb-0 fs-5" style={{ maxWidth: '800px', margin: '0 auto', opacity: 0.8 }}>
                            Explore how we’ve helped businesses like yours leverage integrated technology and creativity to solve complex challenges and achieve key objectives.
                        </p>
                    </div>
