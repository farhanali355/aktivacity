                    ...
                    <div className="d-flex align-items-center justify-content-between flex-wrap gap-5 mb-xxl-15 mb-xl-12 mb-lg-10 mb-md-10 mb-sm-10 mb-9">
                        <div className="pricing-title">
                            <div className="radius-btn text-uppercase cmn-border d-inline-flex radius100 py-xxl-2 py-2 px-xxl-4 px-4 theme-clr gap-xxl-4 gap-3 mb-xxl-8 mb-xl-6 mb-5">
                                {data?.tagline || 'OUR EXPERTS'}
                            </div>
                            <h2 className="stitle" dangerouslySetInnerHTML={{ __html: data?.heading || 'GO <span class="fw-400">TEAM</span>' }} />
                        </div>
                        ...
                        <Tilt options={toltOptions} className="col-xl-3 col-lg-4 col-md-6 col-sm-6" data-aos="fadein" data-aos-duration={1400}>
                            <div className="team-card01 tilt overflow-hidden">
                                <div className="thumb overflow-hidden w-100 position-relative mb-xxl-7 mb-xl-6 mb-5">
                                    <img src="/assets/img/element/sibghat-bhai.jpeg" alt="img" className="w-100" />
                                    <ul className="common-social d-flex align-items-center justify-content-center gap-xxl-3 gap-xl-2 gap-1">
                                        <li>
                                            <Link href="https://www.facebook.com/share/19obMxoAVf/?mibextid=wwXIfr" className="text-center d-center">
                                        ...
                                        <li>
                                            <Link href="https://www.instagram.com/sibghatshaikh/" className="text-center d-center">
                                        ...
                                        <li>
                                            <Link href="https://x.com/sibghat382?s=21" className="text-center d-center">
                                ...
                                <div className="content">
                                    ...
                                    <h5 className="white-clr whitehover">
                                        <Link href="/team-details" className="white-clr whitehover">Sibghat Shaikh </Link>
                                    </h5>
                                </div>
                            </div>
                        </Tilt>
