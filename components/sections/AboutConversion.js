...
export default function AboutConversion() {
    return (
        <section className="final-conversion-section py-xxl-25 py-20 bg-black position-relative overflow-hidden">
            ...
            <div className="container position-relative z-1">
                {/* THE CARD */}
                <div className="conversion-card mx-auto p-xxl-15 p-xl-12 p-8 text-center" data-aos="zoom-in" data-aos-duration="1200">
                    <h2 className="display-2 fw-black black-clr mb-8">Ready to Build Smarter?</h2>
                    <p className="black-clr fs-4 opacity-75 mb-12 max-w-700 mx-auto">
                      Work with a team that understands how to connect AI, creativity, and technology for real business growth.
                    </p>

                    <Link href="/contact" className="book-call-btn d-inline-flex text-decoration-none  align-items-center gap-4 py-3 px-8 rounded-pill text-black fw-bold text-uppercase ls-2">
                        <span style={{ paddingTop: '2px', paddingLeft: '10px', color: 'black' }}>Start Your Partnership</span>
