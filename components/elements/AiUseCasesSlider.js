...
const slides = [
  {
    ...
    desc: 'Automated campaign automation, content automation, follow-ups, and lead generation automation for always-on marketing.',
    image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?q=80&w=2015&auto=format&fit=crop'
  },
  {
    category: 'Customer Support',
    title: 'Customer Support Automation with AI Chatbots',
    desc: 'AI chatbots and intelligent virtual assistants handle FAQs, order status, and support triage before human escalation.',
  ...
  },
  {
    ...
    desc: 'Lead scoring, routing, follow-up reminders, and pipeline updates using AI business automation and CRM integration.',
  ...
  },
  {
    ...
    desc: 'Invoicing support, data entry, report generation, and admin tasks are powered by RPA and workflow orchestration.',
    image: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?q=80&w=2070&auto=format&fit=crop'
  },
  {
    category: 'Content',
    title: 'YouTube & Content Automation Systems',
    desc: 'YouTube automation AI workflows for content scheduling, metadata optimization, and performance tracking.',
    image: 'https://images.unsplash.com/photo-1611162617474-5b21e879e113?q=80&w=2074&auto=format&fit=crop'
  }
]

export default function AiUseCasesSlider({ slides: propSlides }) {
  ...
  return (
    <div className="spotlight-card position-relative overflow-hidden" onTouchStart={onTouchStart} onTouchEnd={onTouchEnd} role="region" aria-label="Use Cases carousel">
