...
const slides = [
  {
    ...
    title: 'Pakistan Fintech SaaS: Automating Credit Approvals',
    bullets: [
      'Challenge: Manual loan processing + data silos',
      'Solution: Custom CRM software development + API integration services',
      'Result: 67% faster loan approvals, 82% data accuracy improvement'
    ],
    image: '/assets/img/software-development/fintech-saas-dashboard.png'
  },
  {
    category: 'Enterprise Solution',
    title: 'Karachi Manufacturing ERP: Scaling Operations',
    bullets: [
      'Challenge: Legacy systems + reporting delays',
      'Solution: Enterprise software development migration + Custom Dashboard',
      'Result: 45% operational efficiency gain, real-time analytics'
    ],
    image: '/assets/img/software-development/manufacturing-erp-dashboard.png'
  }
]

export default function SoftwareShowcaseSlider() {
  ...
  return (
    <div className="spotlight-card position-relative overflow-hidden" onTouchStart={onTouchStart} onTouchEnd={onTouchEnd} role="region" aria-label="Software showcase carousel">
      {slides.map((s, i) => (
