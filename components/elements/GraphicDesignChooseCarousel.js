...
const items = [
  {
    title: "Creative Graphic Design Agency in Karachi",
    icon: "fas fa-map-marker-alt",
    desc: "Local insight with brand and campaign experience across Pakistan and beyond."
  },
  {
    title: "Strategy-Driven, Branding-Led Design Approach",
    icon: "fas fa-bullseye",
    desc: "Every visual decision is rooted in brand strategy, not just aesthetics."
  },
  {
    title: "Consistent High-Quality Output",
    icon: "fas fa-check-circle",
    desc: "Robust brand systems and brand guidelines ensure consistency everywhere your brand appears."
  },
  {
    title: "Fast Turnaround and Collaboration",
    icon: "fas fa-clock",
    desc: "Clear communication, structured feedback rounds, and dependable delivery timelines."
  },
  {
    title: "Business-Focused Visual Storytelling",
    icon: "fas fa-chart-line",
    desc: "Design that supports professional brand image, market differentiation, and real business outcomes."
  }
]

export default function GraphicDesignChooseCarousel() {
