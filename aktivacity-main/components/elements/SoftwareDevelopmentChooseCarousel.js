...
const items = [
    {
        ...
        icon: "fas fa-medal",
        desc: "10+ years of experience delivering custom software solutions across multiple industries and business models."
    },
    {
        title: "Modern & Scalable Tech Stack",
        icon: "fas fa-layer-group",
        desc: "We use reliable technologies like React, Node.js, and cloud platforms to build secure and scalable systems."
    },
    {
        title: "Transparent Agile Process",
        icon: "fas fa-sync-alt",
        desc: "Bi-weekly updates, clear communication, and flexible development ensure full visibility at every stage."
    },
    {
        title: "Industry-Focused Solutions",
        icon: "fas fa-industry",
        desc: "Deep understanding of fintech, manufacturing, healthcare, and e-commerce systems and workflows."
    },
    {
        title: "Global Quality Standards",
        icon: "fas fa-shield-alt",
        desc: "We follow best practices in development, security, and performance to deliver high-quality software."
    },
    {
        title: "Long-Term Technology Partner",
        icon: "fas fa-handshake",
        desc: "From MVP to enterprise scale, we support your growth with continuous improvements and support."
    }
]

export default function SoftwareDevelopmentChooseCarousel() {
