                                    ...
                                    <div className="col-lg-7">
                                        <div className="services-hero-content text-start">
                                            ...
                                            <h1 className="black-clr mb-xxl-8 mb-xl-6 mb-5 display-3 fw-bold">
                                                Digital Marketing Agency in Karachi Driving Measurable Growth
                                            </h1>
                                            {/* <h4 className="black-clr mb-xxl-6 mb-xl-5 mb-4 fw-medium opacity-75">
                                                Your Trusted Partner for Digital Marketing That Drives Real Business Growth
                                            </h4> */}
                                            <p className="black-clr mb-xxl-10 mb-xl-8 mb-6 fs-5 opacity-75">
                                                Aktivacity delivers professional digital marketing services in Karachi focused on increasing brand visibility, generating qualified leads, and maximizing ROI through performance-driven strategies across SEO, paid media, and social platforms. As a full-funnel digital marketing agency in Karachi, we combine strategy, execution, and analytics to help brands grow consistently, without wasting ad spend.                                          </p>
                                    ...
                                    <div className="problem-card p-xxl-6 p-xl-5 p-4 rounded-4">
                                        <div className="d-flex align-items-start gap-4">
                                            ...
                                            <div className="card-text">
                                                ...
                                                <p className="pra-clr mb-0 small">
                                                    You’re investing in ads, but poor targeting, weak messaging, and limited performance tracking turn campaigns into cost centers instead of profit drivers.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="problem-card p-xxl-6 p-xl-5 p-4 rounded-4">
                                        <div className="d-flex align-items-start gap-4">
                                            ...
                                            <div className="card-text">
                                                ...
                                                <p className="pra-clr mb-0 small">
                                                    Your social media presence looks active but doesn’t translate into inquiries, leads, or sales because there’s no clear digital marketing strategy behind the content.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="problem-card p-xxl-6 p-xl-5 p-4 rounded-4">
                                        <div className="d-flex align-items-start gap-4">
                                            ...
                                            <div className="card-text">
                                                ...
                                                <p className="pra-clr mb-0 small">
                                                    Traffic lands on your website or landing pages but fails to convert due to weak sales funnel strategy, misaligned messaging, and lack of conversion rate optimization (CRO).
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div className="row g-xxl-15 g-xl-12 g-10">
                            ...
                            <div className="col-lg-5">
                                ...
                                <p className="pra-clr fs-5">
                                    We act as your performance-focused digital marketing company in Karachi, delivering an integrated mix of search, paid media, and content to drive measurable business outcomes, not vanity metrics.
                                </p>
                            </div>
                            ...
                            <div className="col-lg-4 mb-4">
                                <div className="section-title h-100 d-flex flex-column justify-content-center pe-lg-15">
                                    ...
                                    <p className="pra-clr fs-6 lh-base opacity-75" >
                                        At Aktivacity, we follow a proven, data-driven process that combines strategy, execution, and optimization. Each step is designed to align marketing efforts with your business objectives, ensuring measurable growth and consistent performance across every channel.                                    </p>
                                </div>
                            </div>
                            ...
                            {[
                                {
                                    ...
                                    points: ["Deep market research, competitive review, and audit of your current digital presence, including SEO, ads, and social channels."]
                                },
                                {
                                    step: "02",
                                    title: "Build a Performance-Driven Strategy",
                                    points: ["Define digital marketing strategy, channel mix, budgets, targeting, and messaging—mapped to your funnel from awareness to conversion."]
                                },
                                {
                                    step: "03",
                                    title: "Execute Campaigns Across Channels",
                                    points: ["Launch SEO, Google Ads, social media advertising, and content marketing campaigns with cohesive creative and targeting."]
                                },
                                {
                                    step: "04",
                                    title: "Optimize Continuously Based on Data",
                                    points: ["Ongoing data-driven optimization, bid and budget adjustments, A/B testing, and funnel improvements to increase ROI over time."]
                                }
                            ].map((item, index) => (
                        ...
                        <div className="row g-xxl-15 g-xl-12 g-10">
                            ...
                            <div className="col-lg-8">
                                ...
                                <div className="faq-wrapper d-flex flex-column gap-6">
                                    {[
                                        {
                                            q: "What digital marketing services do you offer in Karachi?",
                                            a: "We provide a full suite of digital marketing services in Karachi, including SEO, Google Ads & PPC management, social media marketing & advertising, content marketing, and conversion rate optimization, all tied together with a clear digital marketing strategy."
                                        },
                                        {
                                            q: "How long does it take to see results?",
                                            a: "SEO typically shows meaningful traction in 3–6 months, while paid campaigns (Google Ads and social ads) can generate results within the first 30–60 days, with performance improving as we optimize based on data."
                                        },
                                        {
                                            q: "Do you manage Google Ads and social campaigns?",
                                            a: "Yes, we act as your performance marketing agency Karachi, managing Google Ads, Facebook & Instagram ads, and other paid channels, from strategy and setup to ongoing optimization and reporting."
                                        },
                                        {
                                            q: "Can you help improve ROI from existing ads?",
                                            a: "Absolutely. We audit your existing campaigns, refine targeting and creatives, improve landing pages, and implement proper tracking to reduce wasted spend and increase return on ad spend."
                                        },
                                        {
                                            q: "Do you provide monthly performance reports?",
                                            a: "Yes, we provide structured monthly reports with key KPIs, insights, and next steps, alongside dashboards for real-time visibility into traffic, leads, and campaign performance."
                                        }
                                    ].map((item, index) => (
                    ...
                    <div className="container position-relative z-1">
                        ...
                        <div className="conversion-card mx-auto p-xxl-15 p-xl-12 p-8 text-center">
                            ...
                            <p className="black-clr fs-4 opacity-75 mb-12 max-w-700 mx-auto">
                             If you’re ready to stop guessing and start scaling with a data-backed digital marketing agency in Karachi, Aktivacity can help you achieve predictable, measurable growth across search, ads, and social.                      </p>
