...
import AiChooseCarousel from '@/components/elements/AiChooseCarousel'
...
export default function AiAutomation() {
    ...
    const deliverables = [
        ...
        },
        {
            ...
            desc: "Build AI chatbots, conversational AI, and AI automation agents for support, FAQs, and guided workflows across web, WhatsApp, and apps."
        },
        {
                                    ...
                                    <div className="problem-card p-xxl-6 p-xl-5 p-4 rounded-4">
                                        <div className="d-flex align-items-start gap-4">
                                            ...
                                            <div className="card-text">
                                                <h5 className="white-clr mb-2 fw-bold">Manual & Repetitive Workflows</h5>
                                                <p className="pra-clr mb-0 small">
                                                    Teams waste hours every week on copy-paste work, updates, and repetitive admin that AI workflow automation can handle in seconds.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    {[
                                        {
                                            ...
                                            a: "AI automation uses AI-powered systems, along with rules and integrations, to enable systems to execute tasks that normally require human intervention, using data and logic to handle tasks such as answering questions, updating records, and directing leads."
                                        },
                                        {
                                            q: "How can AI automation improve business efficiency?",
                                            a: "AI automation achieves operational efficiency through three main functions: automating repetitive tasks, synchronizing data across platforms, and providing predictive analytics for decision-making."
                                        },
                                        {
                                            q: "Do you provide AI automation services in Karachi?",
                                            a: "Our local AI automation agency, based in Karachi, serves businesses across Karachi and Pakistan by providing remote system implementation and technical assistance."
                                        },
                                        {
                                            q: "Can AI agents replace manual processes?",
                                            a: "In many cases, AI automation agents and AI support automation can fully handle repetitive workflows. At the same time, complex or sensitive tasks still benefit from human review, giving you a hybrid, intelligent automation model."
                                        },
                                        {
                                            q: "How long does automation implementation take?",
                                            a: "Smaller AI workflow automation projects can go live in 3–6 weeks, while broader enterprise automation programs may span 2–4 months, depending on process complexity, integrations, and compliance needs."
                                        }
                                    ].map((item, index) => (
                ...
                <section className="final-conversion-section py-xxl-25 py-20 bg-black position-relative overflow-hidden">
                    ...
                    <div className="container position-relative z-1">
                        ...
                        <div className="conversion-card mx-auto p-xxl-15 p-xl-12 p-8 text-center">
                            <h2 className="display-2 fw-black black-clr mb-8">Let’s Build Smarter Systems</h2>
                            <p className="black-clr fs-4 opacity-75 mb-12 max-w-700 mx-auto">
                               If you’re ready to replace manual, error-prone workflows with AI-powered automation that scales, Aktivacity can design and deploy intelligent systems tailored to your business.                           </p>
