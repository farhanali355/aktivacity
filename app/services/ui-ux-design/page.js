                                ...
                                <div className="row align-items-center g-xxl-10 g-5 position-relative z-1">
                                    ...
                                    <div className="col-lg-5">
                                        <div className="services-hero-thumb position-relative text-center">
                                            <img src="/assets/img/web-app/web-app-hero-image.png" alt="UI/UX Design" className="img-fluid floating-img" />
                                            {/* Tech Tags */}
                                            <div className="tech-tag tag-react">Figma</div>
                                            <div className="tech-tag tag-node">Sketch</div>
                                            <div className="tech-tag tag-ios">Adobe XD</div>
                                            <div className="tech-tag tag-aws">Userflow</div>
                            ...
                            <div className="col-lg-6">
                                ...
                                <div className="problem-cards-wrap d-flex flex-column gap-4">
                                    ...
                                    <div className="problem-card p-xxl-6 p-xl-5 p-4 rounded-4">
                                        <div className="d-flex align-items-start gap-4">
                                            ...
                                            <div className="card-text">
                                                <h5 className="white-clr mb-2 fw-bold">Poor User Engagement</h5>
                                                <p className="pra-clr mb-0 small">
                                                    Visitors leave due to confusing UI design and navigation (73% bounce rate).
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="problem-card p-xxl-6 p-xl-5 p-4 rounded-4">
                                        <div className="d-flex align-items-start gap-4">
                                            <div className="card-icon">
                                                <i className="fas fa-route theme-clr fs-3" />
                                            </div>
                                            <div className="card-text">
                                                <h5 className="white-clr mb-2 fw-bold">Low Conversion Rates</h5>
                                                <p className="pra-clr mb-0 small">
                                                    Bad user experience design prevents checkout/form completion (62% drop-off).
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="problem-card p-xxl-6 p-xl-5 p-4 rounded-4">
                                        <div className="d-flex align-items-start gap-4">
                                            <div className="card-icon">
                                                <i className="fas fa-palette theme-clr fs-3" />
                                            </div>
                                            <div className="card-text">
                                                <h5 className="white-clr mb-2 fw-bold">Inconsistent Brand Experience</h5>
                                                <p className="pra-clr mb-0 small">
                                                    Unclear visuals + poor interaction design reduce trust (41% credibility loss).
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="problem-card p-xxl-6 p-xl-5 p-4 rounded-4">
                                        <div className="d-flex align-items-start gap-4">
                                            <div className="card-icon">
                                                <i className="fas fa-mobile-alt theme-clr fs-3" />
                                            </div>
                                            <div className="card-text">
                                                <h5 className="white-clr mb-2 fw-bold">Mobile Usability Issues</h5>
                                                <p className="pra-clr mb-0 small">
                                                    Non-responsive interfaces lose 54% mobile retention.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        >
                                            <div className="d-flex justify-content-between align-items-center mb-0 item-header">
                                                <div className="d-flex align-items-center gap-4">
                                                    <i className={`${item.icon} ${activeDeliv === index ? 'theme-clr' : 'pra-clr'} fs-5`} />
                                                    <h4 className="white-clr mb-0 fw-medium transition-all">{item.title}</h4>
                                                </div>
                        ...
                        <div className="row g-4 align-items-stretch">
                            ...
                            <div className="col-lg-4 mb-4">
                                <div className="section-title h-100 d-flex flex-column justify-content-center pe-lg-15">
                                    ...
                                    <h2 className="white-clr display-3 fw-bold mb-8 lh-1 headline" style={{ fontSize: "37px" }}>
                                ...
                                <div key={index} className="col-lg-4 mb-4">
                                    <div className="process-card p-xxl-8 p-xl-6 p-5 h-100">
                                        <div className="d-flex align-items-center justify-content-between mb-5">
                                            ...
                                            <div className="card-icon">
                                                <i className={`${item.icon} theme-clr opacity-25 fs-2`} />
                                            </div>
                                        </div>
                    ...
                    <div className="container mt-20">
                        <div className="text-center mb-xxl-15 mb-xl-12 mb-10">
                            ...
                            <h2 className="white-clr display-4 fw-bold mb-0 text-uppercase ls-2">
                                UX <span className="theme-clr" style={{ fontSize: 'inherit' }}>Results That Drive Growth</span>
                            </h2>
                        </div>
                    ...
                    <div className="container mt-20">
                        <div className="row g-xxl-15 g-xl-12 g-10">
                            ...
                            <div className="col-lg-8">
                                <h2 className="white-clr display-3 fw-bold mb-12">UI/UX Design FAQs</h2>

                                <div className="faq-wrapper d-flex flex-column gap-6">
                                    {[
                                        {
                                            q: "What is UI/UX design and why is it important?",
                                            a: "UI = visual layer (buttons, colors). UX = user journey (flows, usability). Together they drive 68% higher conversions."
                                        },
                                        {
                                            q: "How long does a UI/UX project take?",
                                            a: "Discovery: 1-2 weeks. Design: 3-6 weeks. Testing: 1-2 weeks. Total: 6-10 weeks typical."
                                        },
                                        {
                                            q: "Do you design for mobile apps and websites?",
                                            a: "Yes - mobile UI UX design, responsive web design, cross-platform consistency."
                                        },
                                        {
                                            q: "Do you provide UI/UX design services in Karachi + Pakistan?",
                                            a: "Karachi studio serving Lahore, Islamabad + Pakistan-wide remote collaboration."
                                        },
                                        {
                    ...
                    <div className="custom-modal-overlay d-flex align-items-center justify-content-center p-4">
                        <div className="modal-content-box bg-white rounded-5 p-xxl-12 p-8 position-relative overflow-hidden">
                            ...
                            <div className="text-center mb-10">
                                <h3 className="black-clr fw-black mb-2">Start Your UI/UX Design Project</h3>
